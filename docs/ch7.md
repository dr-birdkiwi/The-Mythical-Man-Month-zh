# 第 7 章 为什么巴比伦塔会失败？（Why Did the Tower of Babel Fail?）
...
1. 清晰的目标？是的——尽管目标本身高远到近乎荒诞。而且，项目早在触及这一根本限制之前，就已经失败了。
2. 人力？非常充足。
3. 材料？在美索不达米亚有着丰富的泥土和柏油沥青。
4. 足够的时间？没有任何时间限制的迹象。
5. 足够的技术？是的，金字塔形的锥形结构本身是稳定的，能够很好地分散压力负荷，砖石建筑技术也已有深厚积累。同样，项目远在触及技术极限之前，就已经失败了。
...
减少交流的方法是人力划分（division of labor）和职责专业化（specialization of function）。通过这两种手段，树状管理结构对详细交流的需求会相应减少。
...
那么技术主管的角色是什么？他对设计进行构思，识别系统的子部分，指明从外部看上去的样子，勾画它的内部结构。他提供整个设计的一致性和概念完整性；他控制系统的复杂程度。当某个技术问题出现时，他提供问题的解决方案，或者根据需要调整系统设计。借用 Al Capp 最爱引用的一句话，他是"攻坚团队的灵魂人物"（inside-man at the skunk works）。他的沟通交流在团队中是首要的。他的工作几乎完全是技术性的。
...
此外还有一些技巧。例如，产品负责人可以通过一些微妙的地位象征（如办公室大小、地毯档次、装修规格等）来彰显技术主管的权威，尽管决策权力的根源仍在于管理职位。
